...
## ---- echo=FALSE--------------------------------------------------------------
RNAseq = data.frame(data.table::fread("/media/sebastian/Data/Libraries/Rseb/inst/extdata/RNAseq_data.tsv", stringsAsFactors = F))
...
knitr::include_graphics("/media/sebastian/Data/Libraries/Rseb/vignettes/images/Rseb_workflow.svg")
...
## ---- echo=FALSE--------------------------------------------------------------
deeptools.matrix = readRDS("/media/sebastian/Data/Libraries/Rseb/inst/extdata/matrix.deepTools.rds")
...
#  > [1] "/media/user/path/to/matrix.deepTools.gz"
