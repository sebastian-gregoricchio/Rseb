...
## Documentation
With the package is available a [PDF manula](https://github.com/sebastian-gregoricchio/Rseb/blob/main/Rseb_0.1.0_manual.pdf).

## Licence
This package is under an [GNU GPL-3] licence.
