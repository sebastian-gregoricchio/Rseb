...
#'
#' @title RNA-seq example
#' @description List result of the function \link{\code{read.computeMatrix.file}} used to read a matrix.gz file generated by deepTools computeMatrix function.
...
#' @format A data frame with 117 rows and 35 variables. Three of these columns are required to run \link{\code{qPCR.rna.exp}}:
#' \describe{
